    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_of_ticket', models.CharField(choices=[('telephonic resolution', 'Telephonic Resolution'), ('require spare utilities', 'Require Spare Utilities'), ('payment pending', 'Payment Pending'), ('received by customer', 'Received By Customer'), ('revisit', 'Revisit'), ('resolved', 'Resolved')], default='telephonic resolution', max_length=200)),
